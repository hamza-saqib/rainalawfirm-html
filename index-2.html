...
<html lang="zxx">
    ...
    <body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="banner-img">
                                <img src="assets/img/banner/banner-img.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
        ...
        <!-- Fun Fact Area -->
        <div class="fun-facts-area fun-facts-2 pt-100 pb-70">
            <div class="container">
        ...
        <!-- About Area -->
        <div class="about-area about-area-two ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-progress">
                            <h2>We Are Specialised & We Fight For Right. ATORN Firm Have Experience With</h2>
                            <div class="progress-contant">
                                <h3>Divorce And Family Cases <span>90%</span></h3>
                                <div class="progress">
                            ...
                            <div class="progress-contant">
                                <h3>Property And Construction <span>80%</span></h3>
                                <div class="progress">
                            ...
                            <div class="progress-contant">
                                <h3>Banking And Finance <span>95%</span></h3>
                                <div class="progress">
                            ...
                            <div class="progress-contant">
                                <h3>Tech And Media <span>85%</span></h3>
                                <div class="progress">
                    ...
                    <div class="col-lg-6">
                        <div class="about-text">
                            <div class="section-title">
                                ...
                                <h2>We Are Top Lawyers And <span>Experienced</span></h2>
                                <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt. Et harum quidem rerum facilis est et.</p> 
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <ul>
